...
export default function AvivaPage(){
    ...
    return(
        <div style={{backgroundColor:"black",position:"absolute", width:"100vw", top:"0"}}>
            <div style={{position:"relative", width:"100%", height:"100%", top:"5rem"}}>
                <table align="center" style={{position:"relative", top:"8%", left:"10%"}}>
                    <tr style={{padding:"0"}}>
                    ...
                    <tr style={{padding:"0"}}>
                        <td style={{padding:"0"}} colSpan={7}>
                            <img src={index_05} width={700} height={19} style={{position:"relative", bottom:"0.4rem"}}></img>
                        </td>
                    </tr>
                    <tr>
                        <td style={{padding:"0", position:"relative", }} colSpan={3}>
                            <img src={index_06} style={{position:"relative", bottom:"0.6rem"}}  width={261} height={32}/>
                        </td>
                        <td colSpan={2} rowSpan={10} style={{position:"relative", top:"6.6rem",right:"27.8rem"}}>
                    ...
                    <tr>
                        <td style={{position:"relative", bottom:"20rem"}}>
                            <Group position="center" bg={theme.colors.gray[9]} w={"100%"}>
                                <Link style={{textDecoration:"none"}} to="/"><Text fz={12} onPointerEnter={()=>{setHoverEtichettaBassa1(true)}} onPointerLeave={()=>{setHoverEtichettaBassa1(false)}} c={hoverEtichettaBassa1?theme.colors.cyan[5]:"white"}>ARREDAMENTO</Text></Link>
                                <Link style={{textDecoration:"none"}} to="/"><Text fz={12} onPointerEnter={()=>{setHoverEtichettaBassa2(true)}} onPointerLeave={()=>{setHoverEtichettaBassa2(false)}} c={hoverEtichettaBassa2?theme.colors.indigo[5]:"white"}>PROFUMERIE</Text></Link>
                                <Link style={{textDecoration:"none"}} to="/"><Text fz={12} onPointerEnter={()=>{setHoverEtichettaBassa3(true)}} onPointerLeave={()=>{setHoverEtichettaBassa3(false)}} c={hoverEtichettaBassa3?theme.colors.blue[5]:"white"}>FASHION</Text></Link>
                                <Link style={{textDecoration:"none"}} to="/"><Text fz={12} onPointerEnter={()=>{setHoverEtichettaBassa4(true)}} onPointerLeave={()=>{setHoverEtichettaBassa4(false)}} c={hoverEtichettaBassa4?theme.colors.yellow[5]:"white"}>KIDS</Text></Link>
                                <Link style={{textDecoration:"none"}} to="/"><Text fz={12} onPointerEnter={()=>{setHoverEtichettaBassa5(true)}} onPointerLeave={()=>{setHoverEtichettaBassa5(false)}} c={hoverEtichettaBassa5?theme.colors.green[5]:"white"}>WELLNESS</Text></Link>
                                <Link style={{textDecoration:"none"}} to="/"><Text fz={12} onPointerEnter={()=>{setHoverEtichettaBassa6(true)}} onPointerLeave={()=>{setHoverEtichettaBassa6(false)}} c={hoverEtichettaBassa6?theme.colors.grape[5]:"white"}>UFFICI</Text></Link>
                                <Link style={{textDecoration:"none"}} to="/"><Text fz={12} onPointerEnter={()=>{setHoverEtichettaBassa7(true)}} onPointerLeave={()=>{setHoverEtichettaBassa7(false)}} c={hoverEtichettaBassa7?theme.colors.red[5]:"white"}>HOTEL&rESTAURANT</Text></Link>
                            </Group>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style={{position:"relative",bottom:"15rem"}} align="center">
                            <img onPointerEnter={()=>{setNob(true)}} onPointerLeave={()=>{setNob(false)}} src={!Nob?nob1:nob2} style={{paddingRight:"150px"}}/><img src={aavivaa} />
                        </td>
                    </tr>
                </table>

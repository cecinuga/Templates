            ...
            <AvivaWrapper>
                <>
                    <SimpleGrid cols={4} spacing={5}>
                        ...
                        <Link to="/"><img src={battipaglia} /></Link>
                        <Link to="/"><img src={fuorigrotta} /></Link>

                        <Link to="/"><img src={foggia} /></Link>
                        <Link to="/"><img src={matera} /></Link>
                        <Link to="/"><img src={potenza} /></Link>
                        <Link to="/"><img src={robologna} /></Link>

                        <Link to="/"><img src={salerno} /></Link>
                        <Link to="/"><img src={sorrento} /></Link>
                        <Link to="/"><img src={valmontone} /></Link>
                        <Link to="/"><img src={vitteman} /></Link>
                    </SimpleGrid>
